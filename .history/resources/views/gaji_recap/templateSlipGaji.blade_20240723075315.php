...
<body>
    {{-- <div class="container mx-auto border rounded mt-5 p-2 pt-3" style="width: 50%;"> --}}
        <div id="slip-gaji-download">
            ...
            <hr>
            <h5 class="text-center fw-bolder mt-5 mb-1">Slip Gaji Pekerja</h5>
            <h6 class="text-center">{{ $monthYear }}</h6>

            <div class="mt-5 mb-3" style="display: flex; justify-content: space-between ;width: 100%">
        ...
        <hr>
        <span class="btn btn-md btn-success mx-auto" onclick="slipGajiDownload()" style="width: max-content; display: flex; align-items: center; justify-content: space-between">
    ...
    <script>
        function slipGajiDownload() {
            var element = document.getElementById('slip-gaji-download');
            // html2pdf().from(element).save();

            var opt = {
                    margin: 1,
                    filename: 'slip-gaji-mipcon.pdf',
