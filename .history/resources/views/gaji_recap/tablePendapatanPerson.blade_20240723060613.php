                    ...
                    <td>
                        <div id="btnAksi{{ $dataSalary->manpower->id }}"> 
                            ...
                            @else
                                ...
                                @else
                                    <button class="btn btn-sm btn-warning" onclick="aksiApproveByKeuangan({{ $dataSalary->manpower->id }})" style="width: 100%; display: flex; align-items: center; justify-content: space-evenly"><span class="material-symbols-outlined">reject</span>Reject</button>
                                @endif
                            @endif
