                ...
                @if(auth()->user()->level == 'hrd' || auth()->user()->level == 'keuangan') 
                        ...
                        <div id="btnAksi{{ $dataSalary->manpower->id }}"> 
                            @if($confirmSalaryPerson->konfirmasi_hrd == true && Auth::user()->level == 'hrd')
                                @if($confirmSalaryPerson->konfirmasi_keuangan == false )
                                    <button class="btn btn-sm btn-danger" onclick="aksiCancelApproveByHRD({{ $dataSalary->manpower->id }})" style="width: 100%; display: flex; align-items: center; justify-content: space-evenly"><span class="material-symbols-outlined">cancel</span>Cancel Approve</button>
                                @else
                                    <button class="btn btn-sm btn-danger" onclick="aksiCancelApproveByHRD({{ $dataSalary->manpower->id }})" style="width: 100%; display: flex; align-items: center; justify-content: space-evenly" disabled><span class="material-symbols-outlined">cancel</span>Cancel Approve</button>
                                @endif
                            ...
                            @else
                                ...
                                @else
                                    @if($confirmSalaryPerson->konfirmasi_hrd == true)
                                        <button class="btn btn-sm btn-warning" onclick="rejectApproveByKeuangan({{ $dataSalary->manpower->id }})" style="width: 100%; display: flex; align-items: center; justify-content: space-evenly"><span class="material-symbols-outlined">cancel</span>Reject</button>
                                    @else
                                        <button class="btn btn-sm btn-warning" onclick="rejectApproveByKeuangan({{ $dataSalary->manpower->id }})" style="width: 100%; display: flex; align-items: center; justify-content: space-evenly" disabled><span class="material-symbols-outlined">cancel</span>Reject</button>
                                    @endif
                                @endif
                            @endif
                    ...
                    <td>
                        @if($confirmSalaryPerson->konfirmasi_hrd == false && Auth::user()->level == 'hrd')
                            <button class="btn btn-sm btn-danger" onclick="aksiApproveByHRD({{ $dataSalary->manpower->id }})" style="width: 100%; display: flex; align-items: center; justify-content: space-evenly"><span class="material-symbols-outlined">check</span>Approve</button>
