...
<body>
    <div class="container mx-auto border rounded mt-5 p-2 pt-3" style="width: 50%;">
        ...
        <hr>
        <span class="material-symbols-outlined" style="width: max-content; display: flex; align-items: center;"><span class="btn btn-md btn-success" >Print</span>printout</span>
