...
<body>
    <div class="container mx-auto border rounded mt-5 p-2 pt-3" style="width: 50%;">
        ...
        <hr>
        <span class="btn btn-md btn-success mx-auto" onclick="window.print()" style="width: max-content; display: flex; align-items: center; justify-content: space-between">
            <span class="material-symbols-outlined me-2" >Download .pdf</span>
            Download
        </span>
