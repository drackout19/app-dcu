                        ...
                        <div id="btnAksi{{ $dataSalary->manpower->id }}"> 
                            ...
                            @else
                                ...
                                @else
                                    ...
                                    @else
                                        <button class="btn btn-sm btn-warning" onclick="aksiApproveByKeuangan({{ $dataSalary->manpower->id }})" style="width: 100%; display: flex; align-items: center; justify-content: space-evenly" disabled><span class="material-symbols-outlined">cancel</span>Reject</button>
                                    @endif
                                @endif
                            @endif
