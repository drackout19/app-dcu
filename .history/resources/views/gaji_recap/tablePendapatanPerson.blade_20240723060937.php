                            ...
                            @else
                                ...
                                @else
                                    @if($confirmSalaryPerson->konfirmasi_hrd == true)
                                        <button class="btn btn-sm btn-warning" onclick="aksiApproveByKeuangan({{ $dataSalary->manpower->id }})" style="width: 100%; display: flex; align-items: center; justify-content: space-evenly"><span class="material-symbols-outlined">cancel</span>Reject</button>
                                    @else
