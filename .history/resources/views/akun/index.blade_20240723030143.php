        ...
        <div>
            <form action="{{ (Auth::user()->level === 'pekerja') ? route('updateProfilePersonPending', Auth::user()->manpower_id) : route('manpower.update', $data->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input class="mt-1" type="password" class="form-control" id="inputPasswordLama" name="inputPasswordLama" placeholder="Password Lama">
                    <input class="mt-1" type="password" class="form-control" id="inputPasswordBaru" name="inputPasswordBaru" placeholder="Password Baru">
                    <input class="mt-1" type="password" class="form-control" id="inputPasswordBaru" name="inputPasswordBaru" placeholder="Konfirmasi Password Baru">
                </div>
