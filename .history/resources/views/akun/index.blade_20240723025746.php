    ...
    <div class="card mx-auto p-5 mt-5" style="width: 60%">
        ...
        <div>
            <form action="{{ (Auth::user()->level === 'pekerja') ? route('updateProfilePersonPending', $data->id) : route('manpower.update', $data->id) }}" method="post" enctype="multipart/form-data">
                ...
                {{-- input nama pekerja --}}
                <div class="mb-3">
                    <label for="password" class="form-label"><h5 class="mb-0">Ubah Password Akun</h5></label>
                    <input type="text" class="form-control" id="password" name="password" value="{{ $data->nama_pekerja }}">
                </div>
                {{-- input jenis kelamin --}}
                <div class="mb-3">
