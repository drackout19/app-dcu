        ...
        <div>
            <form action="{{ (Auth::user()->level === 'pekerja') ? route('updateProfilePersonPending', $data->id) : route('manpower.update', $data->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="inputPasswordLama" name="inputPasswordLama" placeholder="Password Lama">
                    <input type="text" class="form-control" id="inputPasswordBaru" name="inputPasswordBaru" placeholder="Password Baru">
                    <input type="text" class="form-control" id="inputPasswordBaru" name="inputPasswordBaru" placeholder="Konfirmasi Password Baru">
                </div>
