        ...
        <div>
            <form action="{{ (Auth::user()->level === 'pekerja') ? route('updateAkunPekerja', Auth::user()->manpower_id) : route('manpower.update', $data->id) }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" id="inputPasswordLama" name="inputPasswordLama" placeholder="Password Lama" required>
                </div>
                <div class="mb-3">
                    <input type="password" class="form-control" id="inputPasswordBaru" name="inputPasswordBaru" placeholder="Password Baru" required>
                </div>
                <div class="mb-3">
                    <input type="password" class="form-control" id="inputKonfirmasiPasswordBaru" name="inputKonfirmasiPasswordBaru" placeholder="Konfirmasi Password Baru" required>
