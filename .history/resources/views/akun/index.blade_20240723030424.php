...
@section('konten')
    ...
    <div class="card mx-auto p-5 mt-5" style="width: 60%">
        ...
        <hr> --}}
        <div>
            <form action="{{ (Auth::user()->level === 'pekerja') ? route('updateAkunPekerja', Auth::user()->manpower_id) : route('manpower.update', $data->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                {{-- input nama pekerja --}}
                <div class="mb-3">
