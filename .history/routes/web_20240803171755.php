...
Route::group(['middleware' => ['auth', 'CekLevel:keuangan,hrd,admin']], function () {
    ...
    Route::resource('/manpower1', [\App\Http\Controllers\ManpowerController::class, 'index']);
...
Route::group(['middleware' => ['auth', 'CekLevel:keuangan,hrd,admin,pekerja']], function () {
    ...
    Route::get('/akun-pekerja/{id}', [\App\Http\Controllers\UserController::class, 'index'])->name('akunPekerja');
    Route::put('/updateAkunPekerja/{id}', [\App\Http\Controllers\UserController::class, 'updateAkunPekerja'])->name('updateAkunPekerja');
    ...
    Route::post('/updatePendapatanGaji', [\App\Http\Controllers\SalaryController::class, 'updatePendapatanGaji'])->name('updatePendapatanGaji');
    Route::post('/approvePendapatanGajiByHRD', [\App\Http\Controllers\SalaryController::class, 'approvePendapatanGajiByHRD'])->name('approvePendapatanGajiByHRD');
    Route::post('/cancelApprovePendapatanGajiByHRD', [\App\Http\Controllers\SalaryController::class, 'cancelApprovePendapatanGajiByHRD'])->name('cancelApprovePendapatanGajiByHRD');
    Route::post('/approvePendapatanGajiByKeuangan', [\App\Http\Controllers\SalaryController::class, 'approvePendapatanGajiByKeuangan'])->name('approvePendapatanGajiByKeuangan');
    Route::post('/cancelApprovePendapatanGajiByKeuangan', [\App\Http\Controllers\SalaryController::class, 'cancelApprovePendapatanGajiByKeuangan'])->name('cancelApprovePendapatanGajiByKeuangan');
    Route::post('/rejectApproveByKeuangan', [\App\Http\Controllers\SalaryController::class, 'rejectApproveByKeuangan'])->name('rejectApproveByKeuangan');
    Route::post('/getViewIndexSlipGajiByMonthYear', [\App\Http\Controllers\SalaryController::class, 'getViewIndexSlipGajiByMonthYear'])->name('getViewIndexSlipGajiByMonthYear');
    // Route::get('/rekap-slip-gaji/{id}/{monthYear}', [\App\Http\Controllers\SalaryController::class, 'edit'])->name('rekap-slip-gaji.edit');
    Route::get('/rekap-slip-gaji/{id}/{monthYear}', [\App\Http\Controllers\SalaryController::class, 'show'])->name('rekap-slip-gaji.show');
    Route::post('/getDataTableTimesheetPerson', [\App\Http\Controllers\SalaryController::class, 'getDataTableTimesheetPerson'])->name('getDataTableTimesheetPerson');
