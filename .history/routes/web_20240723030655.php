...
Route::group(['middleware' => ['auth', 'CekLevel:keuangan,hrd,admin,pekerja']], function () {
    ...
    Route::get('/akun-pekerja/{id}', [\App\Http\Controllers\UserController::class, 'index']);
    Route::post('/updateAkunPekerja/{id}', [\App\Http\Controllers\UserController::class, 'updateAkunPekerja']->name('updateAkunPekerja'));
