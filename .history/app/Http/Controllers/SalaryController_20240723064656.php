...
class SalaryController extends Controller
{
    ...
    public function getSlipGajiPerson(Request $request) {
        ...
        if($confirmSalaryPerson->status_gaji == false) {
            ...
            return view('gaji_recap.templateSlipGaji', ["dataSalary" => $dataSalary, "arrDataTimesheet" => $arrDataTimesheet, "dataManpower" => $dataManpower, "monthYear" => $request->monthYear, "tanggal_cetak" => $confirmSalaryPerson->tanggal_cetak]);
        }
