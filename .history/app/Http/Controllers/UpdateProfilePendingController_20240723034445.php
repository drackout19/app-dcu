...
class UpdateProfilePendingController extends Controller
{
    ...
    public function index()
    {
        ...
        // $dataUpdatePending = UpdateProfilePending::where('manpower_id', Auth::user()->manpower_id)->orderBy('id', 'desc')->first();
        // $dataUpdatePending = UpdateProfilePending::all()->with('');
        // $updatePending = $dataUpdatePending->status_konfirmasi;

        return view('konfirmasi_perubahan_data.index', ["manpowers" => Manpower::all, "updatePending" => UpdateProfilePending::all()]);
    }
