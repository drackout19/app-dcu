...
class SalaryController extends Controller
{
    ...
    public function getSlipGajiPerson(Request $request) {
        ...
        if($confirmSalaryPerson->status_gaji == false) {
            ...
            return view('gaji_recap.templateSlipGaji', ["dataSalary" => $dataSalary, "arrDataTimesheet" => $arrDataTimesheet, "dataManpower" => $dataManpower, "monthYear" => $request->monthYear, "confirmSalaryPerson" => $confirmSalaryPerson->tanggal_cetak]);
        }
    ...
    public function rejectApproveByKeuangan(Request $request)
    {
        $dataSalaryPerson = Salary::where('manpower_id', $request->id)->first();
        $confirmSalaryPerson = ConfirmSalary::where('salary_id', $dataSalaryPerson->id)->first();
