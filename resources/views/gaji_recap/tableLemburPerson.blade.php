                                ...
                                if($day <= 9) {
                                    ...
                                    // if($dataDCU->tanggal == '^\d{4}-\d{2}-'.$day.'$') {
                                        ...
                                        if($dataDCU->status_dcu != 'UNFIT') {
                                            if(($timesheets->where('dcurecap_id', $dataDCU->id)->first()) != null) {
                                                // echo '✅';
                                                $totalWaktuLemburDay = $timesheets->where('dcurecap_id', $dataDCU->id)->first();
                                                if($totalWaktuLemburDay->totalWaktuLembur != null) {
                                                    $totalWaktuLemburDay = $totalWaktuLemburDay->totalWaktuLembur;

                                                    preg_match('/\d+\s*Jam/', $totalWaktuLemburDay, $matches);
