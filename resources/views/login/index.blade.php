...
<body style="background-image: url('/image/bg-kilang-1.png')">
    <div class="ms-auto me-3 mt-3" style="max-width: max-content">
        <a href="/login-staff"><button class="btn btn-md btn-dark" >Login Staff</button></a>
    </div>
    <div class="container" style="background: transparent">
        <div class="row">
          <div class="col-md-6 offset-md-3" >
            <h1 class="text-center text-white mt-5 fw-bolder" style="text-shadow: 0px 20px 30px black;">LOGIN</h1>
            
            <div class=" mt-5" style=" box-shadow: 0px 0px 40px rgba(88, 88, 88, 0.7); border-radius: 20px; background: rgba(1, 1, 1, 0.5);">
    
              <form action="{{ route('postLogin') }}" method="post" class="card-body cardbody-color p-5 pb-1 pt-2" style="border-radius: 20px; background: rgba(255, 255, 255, 0.5);">
                @csrf
                ...
                <div class="mb-3 mt-5">
                  <input type="number" class="form-control" id="id_badge" name="id_badge"
